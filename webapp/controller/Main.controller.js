sap.ui.define([
	...
	//return Controller.extend("QuickViewExample.controller.Main", {
var CController = Controller.extend("QuickViewExample.controller.Main", {
						...
						groups: [
							{
								...
								elements: [
									...
									{
										label: "Social Media",
										linkIcon: "/res/lnkdin.png",
										value: "LinkedIn",
										url: "https://www.linkedin.com/in/alexander-sperling-668b1362/",
										elementType: sap.m.QuickViewGroupElementType.link
									}
								]
							},
		...
		createPopover: function() {
			if (!this._oQuickView) {
				this._oQuickView = sap.ui.xmlfragment("QuickViewExample.view.QuickView", this);
